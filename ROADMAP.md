...
| RE | Enrollment & Shift refining (CRUD karyawan/shift, NIK, hapus foto per karyawan) | [~] deploy gspe-ai3 (branch), PENDING E2E user + merge | — | backend 339, vision 177, frontend 118; UI 390px overflow 0; `docs/evidence/enrollment-*.png` | `f8028ed` |
...
## Enrollment & Shift refining — **deploy branch, PENDING E2E user + merge**
...
- [ ] E2E user di UI, lalu merge `--no-ff` ke `main` dan server kembali ke `main`
