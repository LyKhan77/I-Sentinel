...
| CP | Event clip pre-buffer (ring mainstream, insiden per kamera) | [~] lokal selesai, PENDING deploy + verifikasi lapangan | — | vision/frontend suite hijau lokal; spec + plan 2026-09-24 | |
