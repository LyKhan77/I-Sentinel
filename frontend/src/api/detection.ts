...
export type DetectorSettings = { default_ai_fps: number; default_confidence: number; motion_enabled: boolean; motion_threshold: number; motion_min_area: number; motion_force_interval_s: number; updated_at: string }
